...
def reponse():
    ...
    texte_send = "Voici la question qui m'a été posée :" + f"\n" + question + "Voici la réponse que j'ai donnée :" + f"\n" + prompt + "À partir du texte ci dessous, determine avec précision si la réponse donnée est juste ou non et, si elle ne l'est pas, donne la bonne réponse avec une explication claire"
